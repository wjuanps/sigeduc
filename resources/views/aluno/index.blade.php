				...
				@isset($alunos)
					@foreach($alunos as $aluno)
						<tr>
							...
							<td>
								<form id="{{ 'formEditarTurmas'.$aluno->id }}" action="{{ Route('editar-turmas-aluno') }}" method="POST">
									@csrf
									...
									<div class="btn-group">
											...
											<ul class="dropdown-menu" role="menu">
												...
												<li>
													...
													<a href="" onclick="event.preventDefault(); document.getElementById({{'\''. 'formEditarTurmas'.$aluno->id . '\'' }}).submit()">Editar Turmas</a href="#">
												</li>
												<li class="divider"></li>
