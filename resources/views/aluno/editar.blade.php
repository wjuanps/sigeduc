			...
			<div class="row-fluid">
				<div class="form-group col-md-3">
					...
					<select name="pratica_ed_fisica" id="praticaEdFisica" class="form-control">
						...
						<option value="Sim" {{ (($aluno->pratica_ed_fisica) ? 'selected' : '') }}>Sim</option>
					</select>
				</div>
				...
				<div class="form-group col-md-3">
					...
					<select name="irmao_na_escola" id="irmaosNaEscola" class="form-control">
						<option value="Nao">Não</option>
						<option value="Sim" {{ (($aluno->irmao_na_escola) ? 'selected' : '') }}>Sim</option> 
					</select>
				</div>
				...
				<div class="form-group col-md-3">
					...
					<select name="pai_declarado" id="paiDeclarado" class="form-control">
						<option value="Nao">Não</option>
						<option value="Sim" {{ (($aluno->pai_declarado) ? 'selected' : '') }}>Sim</option>
					</select>
				</div>
			</div>
			...
			<div id="tabelaSelecionarResponsavel" class="">
				<div class="row-fluid">
					...
					<div class="form-group col-md-2">
						<button class="btn btn-success pesquisar-responsavel" title="Pesquisar" type="button"><i class="fa fa-search fw"></i></button>
					</div>
				</div>
							...
							@isset($aluno->responsaveis)
								@foreach($aluno->responsaveis as $responsavel)
									<tr>
										...
										<td>{{ (($responsavel->pivot->mora_com_filho) ? 'Sim' : 'Não') }}</td>
										<td><button class="btn btn-success btn-sm"><i class="fa fa-edit fw"></i></button></td>
									</tr>
								@endforeach
							@endisset
						</tbody>
